...
interface IPlayOptions {
    ...
    function performOption(address gameMaster, address player, uint8 spaceType, uint8 assetId, uint256 assetPrice, uint256 productPrice, uint8 option, uint8 currentCardId) external returns (uint8 realOption);
}